        ...
        case 'remove':
          if (chat.welcome) {
            ...
            for (let user of participants) {
              let kai = await(await fetch('https://telegra.ph/file/dd8e0c00856542b917458.jpg')).buffer()
              let poi = await(await fetch('https://telegra.ph/file/dd8e0c00856542b917458.jpg')).buffer()
